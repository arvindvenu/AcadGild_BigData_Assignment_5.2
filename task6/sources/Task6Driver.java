...
/**
 * @author arvind
 * This class is the driver (main class) for Assignment 5.2 task 6. This is the 
 ...
 * But to save bandwidth later in the shuffle and sort phase, we use a combiner. 
 * A combiner is like a mini reducer. It performs the function of the reducer but only 
 * on the output of each mapper    
 */
